...
*The application <b>finances_mail_invoices_and_bills</b> doesn't use Django's server or any endpoint or url from it, but just its model and a single view instantiated out of its projects' folder.
